...
<template>
  ...
  <div v-if="step === 2" class="container">
    <h2>Eu sabia que você não iria resistir, hihihihi!</h2>
    <h3>Quando finalizar é só dizer "Eu amo batata frita" que eu te mando mais informações no Whatsapp! Te amooo! 🥰</h3>
